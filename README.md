...
Αφαιρέθηκαν πριν το preprocessing χαρακτηριστικά όπως ids, weights και survey_id γιατι στα μοντέλα δεν χρειάζονται αυτα. Το weights βάση εκφωνησης υπάρχει μέσα στις μεταβλητές που χρησιμοποίηθηκαν για ν αυπολογιστεί.
